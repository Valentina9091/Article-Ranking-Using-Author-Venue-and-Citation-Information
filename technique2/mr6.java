...
public class mr6 extends Configured implements Tool {
	
	static final Logger LOG = Logger.getLogger(mr6.class.getName());
	public static void main(String[] args) throws Exception {
		Configuration conf= new Configuration(true);
		@SuppressWarnings("unused")
		int res = ToolRunner.run(conf,new mr6(), args);
	}
	...
	public int run(String[] args) throws Exception {
		...
		Job job = Job.getInstance(config, "mr6");
	...
	public static class Map extends
		...
		public void map(LongWritable offset, Text lineText, Context context)
			...
			for(String record:recArr){
				...
				//LOG.info(outlinkSplit[2] +"HEREEEEEEEEEE");
	...
	public static class Reduce extends
		...
		public void reduce(Text key, Iterable<FloatWritable> valueList,Context context) throws IOException, InterruptedException {
			...
			Av=aggregatePaperscore/(float)counter;
